var menus = {
    "&File": [{
        ...
        {
            item: "设置为壁纸(&Centered)", // in mspaint it's Wa&llpaper
    ...
    "&View": [{
        ...
        $MenuBar.DIVIDER,
        {
            item: "&xEXTRAS选项(extras有很多功能,可以改主题)",
            checkbox: {
                toggle: function() {
    ...
    "&Help": [{
        ...
        $MenuBar.DIVIDER,
        {
            ...
            action: function() {
                ...
                $msgbox.$content.html(
                    "<h1><img src='images/icons/32.png'/>Good Web Paint<hr/></h1>" +
                    "<p>WebPaint By lmsdscav</p>"
                ).css({ padding: "15px" });
                $msgbox.center();
            },
